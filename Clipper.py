...
class ClipButton(QPushButton):
    def __init__(self, clip_instance, icon_type=None, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.clip_instance = clip_instance
        self.left_arrow = QPixmap(resource_path("imgs/1.png")).scaled(150, 150, Qt.KeepAspectRatio, Qt.SmoothTransformation)
        self.right_arrow = QPixmap(resource_path("imgs/2.png")).scaled(150, 150, Qt.KeepAspectRatio, Qt.SmoothTransformation)
...
class blurButton(QPushButton):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.blue_spread = QPixmap(resource_path("imgs/blue_spread.png")).scaled(700, 700, Qt.KeepAspectRatio, Qt.SmoothTransformation)
...
class ClipUI(QWidget):
    def __init__(self, *args, **kwargs):
        ...
        self.scarab_window_icon = QIcon(resource_path('imgs/scarab_window_icon.png'))
        self.setWindowIcon(self.scarab_window_icon)
        self.neon_rain = QPixmap(resource_path("imgs/neon_rain.png")).scaled(350, 400, Qt.KeepAspectRatio, Qt.SmoothTransformation)
        self.scarab_icon = QPixmap(resource_path("imgs/scarab.png")).scaled(124, 124, Qt.KeepAspectRatio, Qt.SmoothTransformation)
        self.copy_button = QPixmap(resource_path("imgs/copy.png")).scaled(100, 150, Qt.KeepAspectRatio, Qt.SmoothTransformation)
        self.copied_button = QPixmap(resource_path("imgs/copied.png")).scaled(100, 150, Qt.KeepAspectRatio, Qt.SmoothTransformation)
        self.city_part_a = QPixmap(resource_path("imgs/skyscraper.png")).scaled(100, 300, Qt.KeepAspectRatio, Qt.SmoothTransformation)
        self.recycle_icon = QPixmap(resource_path("imgs/recycle.png")).scaled(124, 124, Qt.KeepAspectRatio, Qt.SmoothTransformation)
